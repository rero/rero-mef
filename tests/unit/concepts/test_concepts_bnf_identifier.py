...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Not a BNF number.
        ("FRBNF177105", None),
        # Nor is a number stating more than the check character.
        ("FRBNF119304681234", None),
        ("FRBNF11930468 Rameau", None),
        ("http://catalogue.bnf.fr/ark:/12148/cb119804687/version", None),
