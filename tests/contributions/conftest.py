...
def mef_record():
    ...
    record = {
        "$schema":
        "http://mef.rero.ch/schemas/mef/mef-contribution-v0.0.1.json",
...
def viaf_record():
    ...
    record = {
        "$schema":
        "http://mef.rero.ch/schemas/viaf/viaf-contribution-v0.0.1.json",
        "pid": "66739143",
        "gnd_pid": "12391664X",
        "rero_pid": "A023655346",
        "idref_pid": "069774331"
...
def gnd_record():
    ...
    record = {
        "$schema":
        "http://mef.rero.ch/schemas/gnd/gnd-contribution-v0.0.1.json",
...
def rero_record():
    ...
    record = {
        "$schema":
        "http://mef.rero.ch/schemas/rero/rero-contribution-v0.0.1.json",
        "bf:Agent": "bf:Person",
...
def idref_record():
    ...
    record = {
        ...
        "gender": "male",
        "$schema":
            "http://mef.rero.ch/schemas/idref/idref-contribution-v0.0.1.json"
    }
    return record
