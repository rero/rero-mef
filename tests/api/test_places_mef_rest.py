...
def test_view_places_mef(client, place_mef_idref_redirect_record,
...
def test_places_mef_get_latest(client,
    ...
    data = PlaceMefRecord.get_latest(pid_type='idref',
                                     pid=place_idref_redirect_record.pid)
    data.pop('_created')
    data.pop('_updated')
...
def test_places_mef_get_updated(client,
                                place_mef_idref_record,
                                place_idref_record,
                                place_mef_idref_redirect_record,
                                place_idref_redirect_record):
    ...
    res, data = postdata(
        client,
        'api_blueprint.place_mef_get_updated',
        {}
    )
    assert res.status_code == 200
