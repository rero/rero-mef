...
def test_oai_save_to_file(mock_sickle, app, init_oai,
                          aggnd_oai_list_records_empty, aggnd_oai_list_records,
                          tmpdir):
    """Test oai harvesting save file."""
    mock_sickle.side_effect = MultipleResponses(
        empty=aggnd_oai_list_records_empty,
        response=aggnd_oai_list_records
    )
...
@mock.patch('sickle.app.Sickle.harvest')
def test_oai_process_records_from_dates(mock_sickle, app, init_oai,
