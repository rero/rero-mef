...
def place_mef_idref_data():
    ...
    return {
        "$schema": "https://mef.rero.ch/schemas/places_mef/"
        "mef-place-v0.0.1.json",
        "deleted": "2022-09-03T07:07:32.545630+00:00",
        "idref": {
            "$ref": "https://mef.rero.ch/api/places/idref/271330163"
        },
        "type": "bf:Place"
    }
...
def place_mef_idref_redirect_data():
    ...
    return {
        ...
        "mef-place-v0.0.1.json",
        "idref": {
            "$ref": "https://mef.rero.ch/api/places/idref/271330163x2"
        },
        "type": "bf:Place"
    }
