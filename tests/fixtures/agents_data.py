...
def agent_viaf_online_response():
    ...
    return {
        ...
        "Document": {
            ...
            "inDataset": {
                "@resource": "http://viaf.org/viaf/data"
            },
            "primaryTopic": {
                "@resource": "http://viaf.org/viaf/124294761"
            }
        },
        "RecFormats": {
            "data": {
        ...
        "history": {
            "ht": [
                {
                    "@recid": "SUDOC|076515788",
                    "@time": "2014-12-17T15:43:51+00:00"
                },
                {
                    "@recid": "DNB|969004222",
                    "@time": "2014-12-17T15:43:51+00:00"
                ...
                {
                    "@recid": "BNF|11717946",
                    "@time": "2016-01-31T03:15:00.183026+00:00"
                },
                {
                    "@recid": "BNF|12544283",
                    "@time": "2016-01-31T03:15:00.229544+00:00"
                },
                {
                    "@recid": "BAV|493_4879",
                    "@time": "2020-07-14T14:21:02.860830+00:00"
                }
            ]
        },
        "languageOfEntity": {
        ...
        "sources": {
            "source": [
                {
                    "#text": "DNB|969004222",
                    "@nsid": "http://d-nb.info/gnd/1248506-8"
                },
                {
                    "#text": "SUDOC|076515788",
                    "@nsid": "076515788"
...
def aggnd_oai_list_records_empty():
    ...
    file_name = join(
        dirname(__file__), '../data/aggnd_oai_list_records_empty.xml')
    with open(file_name, 'rb') as file:
        return file.read()
