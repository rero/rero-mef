...
This module provides classes and functionality for managing place entities
(geographic locations, jurisdictions) from multiple authority sources. Places
are aggregated into MEF records that link equivalent geographic entities
