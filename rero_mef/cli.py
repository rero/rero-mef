...
def bulk_load(**kwargs):
    ...
    if 'marctojson' in params and params['marctojson']:
        ...
        message = '  Transform MARC to JSON. {file} {deleted_file}'.format(
            file=json_file,
        ...
        message = '  Number of JSON records deleted: {number}. '.format(
            number=number_records_in_file(json_deleted_file, 'json'))
        click.secho(message, fg='green', err=True)
